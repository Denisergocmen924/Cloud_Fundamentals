...
![Şekil 1.1 — CPU'nun temel blok diyagramı](diagrams/hw-1-01-cpu-blocks.png)
...
![Şekil 1.2 — Fetch-decode-execute döngüsü ve veri akışı](diagrams/hw-1-02-fetch-decode-execute.png)
...
![Şekil 1.3 — Pipeline zaman diyagramı](diagrams/hw-1-03-pipeline.png)
...
![Şekil 1.4 — Çok çekirdekli CPU yerleşimi](diagrams/hw-1-04-multicore-layout.png)
