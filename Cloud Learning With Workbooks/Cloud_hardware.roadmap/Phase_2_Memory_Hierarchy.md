...
![Figure 2.1 — Memory hierarchy pyramid](diagrams/hw-2-01-memory-pyramid.png)
...
![Figure 2.2 — Effect of row-major and column-major access on cache lines](diagrams/hw-2-02-row-vs-column.png)
