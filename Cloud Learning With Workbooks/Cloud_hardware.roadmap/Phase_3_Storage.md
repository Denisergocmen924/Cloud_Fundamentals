...
![Figure 3.1 — Mechanical components of an HDD and the path a read follows](diagrams/hw-3-01-hdd-anatomy.png)
...
![Figure 3.2 — Page/block asymmetry in an SSD and the FTL's out-of-place write strategy](diagrams/hw-3-02-ssd-pages-blocks.png)
...
![Figure 3.3 — SATA's single-queue path and NVMe's per-core queue architecture](diagrams/hw-3-03-sata-vs-nvme.png)
...
![Figure 3.4 — IOPS-bound and throughput-bound workloads compared on the same device](diagrams/hw-3-04-iops-vs-throughput.png)
...
![Figure 3.5 — Data placement in RAID 0, 1, 5 and 10](diagrams/hw-3-05-raid-levels.png)
