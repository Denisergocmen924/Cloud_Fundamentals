...
![Figure 6.1 — VMX root / non-root modes and the VM exit cycle](../diagrams/png/hw-6-01-vmx-modes.png)
...
![Figure 6.2 — A comparison of the traditional hypervisor and the Nitro architecture](../diagrams/png/hw-6-02-nitro-architecture.png)
