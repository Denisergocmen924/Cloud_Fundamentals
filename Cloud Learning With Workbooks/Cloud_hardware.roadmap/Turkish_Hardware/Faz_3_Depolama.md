...
![Şekil 3.1 — HDD'nin mekanik bileşenleri ve bir okumanın izlediği yol](../diagrams/png/hw-3-01-hdd-anatomy.png)
...
![Şekil 3.2 — SSD'de sayfa/blok asimetrisi ve FTL'nin yerinde-olmayan yazma stratejisi](../diagrams/png/hw-3-02-ssd-pages-blocks.png)
...
![Şekil 3.3 — SATA'nın tek kuyruklu yolu ve NVMe'nin çekirdek başına kuyruk mimarisi](../diagrams/png/hw-3-03-sata-vs-nvme.png)
...
![Şekil 3.4 — Aynı cihazda IOPS-sınırlı ve throughput-sınırlı iş yüklerinin karşılaştırması](../diagrams/png/hw-3-04-iops-vs-throughput.png)
...
![Şekil 3.5 — RAID 0, 1, 5 ve 10'un veri yerleşimi](../diagrams/png/hw-3-05-raid-levels.png)
