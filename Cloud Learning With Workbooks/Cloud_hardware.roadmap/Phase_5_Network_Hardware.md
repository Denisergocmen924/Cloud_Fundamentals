...
![Figure 5.1 — The shared medium of a hub versus the point-to-point switching of a switch](diagrams/hw-5-01-hub-vs-switch.png)
...
![Figure 5.2 — The four components of latency and the room for intervention in each](diagrams/hw-5-02-latency-components.png)
